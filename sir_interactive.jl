...
using DifferentialEquations, CairoMakie, Roots, Printf, PlutoUI, DataFrames, Colors

# ╔═╡ 426cd16f-9d0b-4e21-bfa7-8da78d324dc9
...
$(@bind R₀ PlutoUI.Slider(1.25:0.25:5))
"
...
begin
	...
	sol = DataFrame(solve(prob, saveat=0.1));
	nothing
end

# ╔═╡ c1e2a43f-df2e-446f-9774-71f6e58d60b5
rename!(sol, Dict(:value1 => :s, :value2 => :i, :value3 => :r));

# ╔═╡ c0c85ee9-0659-47b9-b1aa-62fdef667934
md"basic reproductive number $R_0$ = $R₀"

# ╔═╡ b5dd3ccc-db87-11ea-1f18-8571cc964420
begin
	sir_to_color = Dict("S" => RGB(0.000000, 0.716877, 0.554419), 
		                "I" => RGB(1.000000, 0.403746, 0.397903),
					    "R" => RGB(0.000000, 0.747369, 1.000000))

	fig = Figure()
	ax  = Axis(fig[1, 1], xlabel="time, γt", ylabel="fraction of population")
	lines!(sol[:, :timestamp], sol[:, :s], 
		label="[S](t)", color=sir_to_color["S"], linewidth=4)
	lines!(sol[:, :timestamp], sol[:, :i], 
		label="[I](t)", color=sir_to_color["I"], linewidth=4)
	lines!(sol[:, :timestamp], sol[:, :r], 
		label="[R](t)", color=sir_to_color["R"], linewidth=4)
	ylims!(0, 1)
	xlims!(0, time_span[2])
	axislegend()
	fig
...
git-tree-sha1 = "1f4022b5b378c627c44212ea6f19ea36d7f9d3e3"
...
git-tree-sha1 = "ee01c1aff6c9c1424b904c37082f56ebfc5e0abb"
...
git-tree-sha1 = "a1c0ac5e794dfaf1c224ca3d2744dcb3252b3ca8"
...
git-tree-sha1 = "5ce9a8e27fcc33881fa8f8c204e92f4f29f78326"
...
git-tree-sha1 = "8ccc645a7afe7000aba981b3cf33efcc40a866b1"
...
git-tree-sha1 = "68c2ee0351edd3c39f67a017d2d1d12f939126dc"
...
git-tree-sha1 = "68f83df57443ddf664e3f0b8a7d49056995b19f6"
...
git-tree-sha1 = "f124bbbd9060f04fc925287c706b03b62e82f1e4"
